...
传统 Agent 工作流：
┌─────────┐    ┌─────────┐    ┌─────────┐
│  Input  │───▶│  Plan   │───▶│ Execute │───▶ Output (可能错误)
└─────────┘    └─────────┘    └─────────┘
                    ↓
              单次规划，无反馈
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  Query ──▶ Query Decomposition ──▶ Parallel Search              │
│                              │                                  │
│                    ┌─────────┼─────────┐                       │
│                    ▼         ▼         ▼                        │
...
│  Q: "法国的首都是什么？"                                         │
│                                                                 │
│  Are there any follow-up questions? Yes.                       │
│    Q: "用户问的是哪个法国？"                                      │
│    A: 法兰西共和国                                             │
│                                                                 │
│  Are there any follow-up questions? No.                        │
│  A: 巴黎                                                       │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
